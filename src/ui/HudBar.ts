...
export class HudBar {
  ...
  constructor(scene: Phaser.Scene) {
    this.scene = scene
    const shadow = scene.add.rectangle(480, 26, 926, 40, 0x000000, 0.55).setDepth(30)
    const panel = scene.add.rectangle(480, 20, 926, 40, CYBER.panel, 0.78)
      .setStrokeStyle(1, CYBER.cyan, 0.68).setDepth(31)
    ...
    this.objects.push(shadow, panel, line, this.moneyText, this.comboText, this.reputationText, this.timerText, this.muteButton, this.muteIcon)
